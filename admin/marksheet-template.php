<?php
// admin/marksheet-template.php
require_once('../common/config.php');
include(__DIR__ . "/includes/header.php");

// Fetch existing Marksheet templates
$stmt = $pdo->prepare("SELECT * FROM document_templates WHERE type = 'marksheet' ORDER BY created_at DESC");
$stmt->execute();
$templates = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>

<div class="pagetitle">
    <h1>Marksheet Template</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo ADMIN_BASE_URL; ?>index.php">Home</a></li>
            <li class="breadcrumb-item">Card Management</li>
            <li class="breadcrumb-item active">Marksheet Template</li>
        </ol>
    </nav>
</div>
                ...
                <div class="card-body pt-3">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle datatable-premium"
                               data-add-btn='{"text":"Add Template","onclick":"openAddTemplate()","icon":"fas fa-file-alt"}'>
                            ...
                            <tbody>
                                ...
                                <tr id="temprow-<?php echo $t['id']; ?>">
                                    ...
                                    <td>
                                        ...
                                        <div class="small text-muted">Type: Marksheet Background</div>
                                    </td>
                                    <td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle"><i class="fas fa-file-alt me-2"></i>Add Marksheet Template</h5>
            ...
            <form id="templateForm" novalidate enctype="multipart/form-data">
                ...
                <div class="modal-body px-3 py-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" id="temp-name" placeholder="e.g. Standard A4 Marksheet" required>
...
function resetTemplateForm() {
    ...
    document.getElementById('modalTitle').innerHTML = '<i class="fas fa-file-alt me-2"></i>Add Marksheet Template';
