<?php
// admin/admit-template.php
require_once('../common/config.php');
include(__DIR__ . "/includes/header.php");

// Fetch existing Admit Card templates
$stmt = $pdo->prepare("SELECT * FROM document_templates WHERE type = 'admit_card' ORDER BY created_at DESC");
$stmt->execute();
$templates = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>

<div class="pagetitle">
    <h1>Admit Card Template</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo ADMIN_BASE_URL; ?>index.php">Home</a></li>
            <li class="breadcrumb-item">Card Management</li>
            <li class="breadcrumb-item active">Admit Template</li>
        </ol>
    </nav>
</div>
                ...
                <div class="card-body pt-3">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle datatable-premium"
                               data-add-btn='{"text":"Add Template","onclick":"openAddTemplate()","icon":"fas fa-file-invoice"}'>
                            ...
                            <tbody>
                                ...
                                <tr id="temprow-<?php echo $t['id']; ?>">
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <div class="bg-light d-flex align-items-center justify-content-center border rounded shadow-sm" style="width: 70px; height: 100px;">
                                    ...
                                    <td>
                                        ...
                                        <div class="small text-muted">Type: Admit Card Background</div>
                                    </td>
                                    <td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle"><i class="fas fa-file-invoice me-2"></i>Add Admit Template</h5>
            ...
            <form id="templateForm" novalidate enctype="multipart/form-data">
                ...
                <input type="hidden" name="type" value="admit_card">
                ...
                <div class="modal-body px-3 py-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" id="temp-name" placeholder="e.g. Annual Exam Admit Card" required>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Recommended: A4 Portrait Resolution (2480 x 3508 px)</small>
                    </div>
                    <div class="mb-0">
...
function resetTemplateForm() {
    ...
    document.getElementById('modalTitle').innerHTML = '<i class="fas fa-file-invoice me-2"></i>Add Admit Template';
