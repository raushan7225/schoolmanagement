<?php
// admin/id-card-template.php
require_once('../common/config.php');
include(__DIR__ . "/includes/header.php");

// Fetch existing ID Card templates
$stmt = $pdo->prepare("SELECT * FROM document_templates WHERE type = 'id_card' ORDER BY created_at DESC");
$stmt->execute();
$templates = $stmt->fetchAll(PDO::FETCH_ASSOC);
?>

<div class="pagetitle">
    <h1>ID Card Template</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo ADMIN_BASE_URL; ?>index.php">Home</a></li>
            <li class="breadcrumb-item">Card Management</li>
            <li class="breadcrumb-item active">ID Card Template</li>
        </ol>
    </nav>
</div>
                ...
                <div class="card-body pt-3">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle datatable-premium"
                               data-add-btn='{"text":"Add Template","onclick":"openAddTemplate()","icon":"fas fa-id-card"}'>
                            ...
                            <tbody>
                                ...
                                <tr id="temprow-<?php echo $t['id']; ?>">
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <div class="bg-light d-flex align-items-center justify-content-center border rounded shadow-sm" style="width: 60px; height: 90px;">
                                    ...
                                    <td>
                                        ...
                                        <div class="small text-muted">Type: Student ID Card Background</div>
                                    </td>
                                    <td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle"><i class="fas fa-id-card me-2"></i>Add ID Card Template</h5>
            ...
            <form id="templateForm" novalidate enctype="multipart/form-data">
                ...
                <div class="modal-body px-3 py-4">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="name" id="temp-name" placeholder="e.g. Standard ID Card 2024" required>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Recommended: 600×900 px (Portrait Orientation)</small>
                    </div>
                    <div class="mb-0">
...
function resetTemplateForm() {
    ...
    document.getElementById('modalTitle').innerHTML = '<i class="fas fa-id-card me-2"></i>Add ID Card Template';
